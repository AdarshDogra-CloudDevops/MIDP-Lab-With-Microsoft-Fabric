...
24. From the Home tab, click on the **drop-down (1)** and select **New SQL query (2)** to write your SQL statements.
    ...
    ![new-sql-query](../media/09/E1T4S23.png)
...
26. Click on **Run (1)** to run the query and view the **Results (2)**.
    ...
    ![view-sql-query-results](../media/09/E1T4S25.png)
...
1. On to the left side click on the workspace, select the newly created **Semanticmodel<inject key="DeploymentID" enableCopy="false" />**.
