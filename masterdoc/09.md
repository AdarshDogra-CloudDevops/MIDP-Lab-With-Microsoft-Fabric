...
1. In the dataset pane, you can view all available tables. You can choose to create a report from scratch, build a paginated report, or let Power BI generate one automatically. For this lab, click the **drop-down (1)** under **Discover business insights** next to **Explore this data**, then select **Auto-create a report (2)**.
