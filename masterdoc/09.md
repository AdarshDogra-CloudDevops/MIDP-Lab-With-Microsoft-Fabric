...
1. Enter the name as **Semanticmodel<inject key="DeploymentID" enableCopy="false" />** **(1)**, select **dbo (2)** , **tables (3)**, **dimension_customer(4)** and then click on **Confirm (5)**.

   ![](../media/newsempopup.png)

1. From the workspace, select the newly created **Semanticmodel<inject key="DeploymentID" enableCopy="false" />**.
