...
1. From the dataset pane, you can view all the tables. You have options to create reports either from scratch, paginated reports, or let Power BI automatically create a report based on your data. For this lab, select **drop-down (1)** for Explore this data and click on **Auto-create a report (2)**.
