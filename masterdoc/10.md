...
10. You can monitor the pipeline execution and activity in the **Output** tab. You can also view detailed data transfer information by selecting the glasses icon next to the pipeline name, which appears when you hover over the name
    ...
    >**Note**: If the Activity Status is **Failed**, follow the given steps to delete the **Data Pipeline** and start the task again.

    >**1**: Navigate back to the **Fabric Lakehouse (1)** and check for your **Data Pipeline (2)**.

    >![add-pipeline-copy-data](../media/10/p10_1.png) 

    >**2**: Click on **Ellipsis ( ... ) (1)** and then **Delete (2)**.

    >![add-pipeline-copy-data](../media/10/p10_2.png) 

    >**3**: Click on **Delete (1)** button and your **Data Pipeline** will be deleted.

    >![add-pipeline-copy-data](../media/10/p10_3.png) 

    >**4**: Wait for **5 minutes** and then again start from **Step 1**. This time your **Activity Status** will be **Succeeded**.
