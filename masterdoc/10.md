...
1. Navigate to the Workspace **Fabric Lakehouse Tutorial** **<inject key="DeploymentID" enableCopy="false" />**, click on the **+ New item (1)** button and search for the **Data pipeline (2)** in the search bar and select **Data pipeline (3)** from the Get data blade.

   ![](../media/10/dp(1).png)

2. In the **New pipeline** dialog box, specify the name as **IngestDataFromSourceToLakehouse (1)** and select **Create (2)**.
...
4. Next, set up an HTTP connection to import the sample World Wide Importers data into the Lakehouse. From the list of Choose data sources, search and select **Http**.

   ![add-pipeline-copy-data](../media/10/dp(4).png)

5. In the **Connect to data source** window, enter the details from the table below and select **Next (7)**.
...
6. In **Choose data destination**, search for **Lakehouse (1)** and select **wwilakehouse (2)**.

   ![add-pipeline-copy-data](../media/10/dp(7).png)

7. In the **Connect to data destination** window, select **Browse (1)** to choose the root folder, confirm by clicking **OK (2)**, and then click **Next (3)** to continue.
...
11. Now, navigate back to Workspace **Fabric Lakehouse Tutorial** **<inject key="DeploymentID" enableCopy="false" />** and select **wwilakehouse** to launch **Lakehouse explorer**.
...
13. The data is generated within the Files section of the Lakehouse Explorer. It appears inside a new folder named with a GUID. To make it easier to identify, rename this folder. Click on the **Ellipsis (...) (1)** next to the folder and choose **Rename (2)** from the context menu.

    ![add-pipeline-copy-data](../media/10/03al.png)

14. Enter the new name as **wwi-raw-data** and click on **Rename** to apply the change.
